...
| `DELETE /api/office/hires/:role`                    | `requireActiveAirline`; office scoped by resolved owner                | 401   | 409 without an owned airline         | Allow when active                        | Same as player/owner        |
