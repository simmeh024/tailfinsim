...
const STRICT_WRITE_CONTRACTS = [
  ...
  },
  {
    ...
    schema: PurchaseHubRequest,
    payload: { airportIdent: 'EHAM', expectedCostMinor: 200_000_000 },
  },
  {
    endpoint: 'POST /api/hubs/:hubId/facilities',
    schema: OpenHubFacilityRequest,
    payload: { kind: 'lounge', expectedCostMinor: 50_000_000 },
  },
  {
...
const COVERED_WRITE_ENDPOINTS = [
  ...
  'POST /api/hubs',
  'POST /api/hubs/:hubId/facilities',
