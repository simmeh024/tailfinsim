...
const CAUSE_LABEL: Record<AdminCashMovementCause, string> = {
  ...
  crew_base_overhead: 'Crew base overhead',
  ...
  ground_contract_penalty: 'Ground contract early termination',
  ground_volume_shortfall: 'Ground contract volume shortfall',
  ground_self_handling_payroll: 'Self-handling payroll',
